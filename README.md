...
<br />
<h2>Level 1</h2>
<b> To log into the Bandit Linux server you need to use SSH. LogOn.sh shows the command & how I used it to get logged into the server. The prompt for Level 1 is below.
